let store = {
    _state: {
        ...
        messagesPage: {
            ...
            messagesData: [
                { id: 1, messagesRead: 'Прочитано', message: 'Приветик это же ВАНЯ!. Привет, Валентина. Как твои дела?', messageFriends: 'Да вроде как все отлично?' },
                { id: 2, messagesRead: 'Ожидает', message: 'Напрямую сделать треугольник средствами CSS нельзя, поэтому доступны два метода, позволяющих его добавить — через border и transform. ... В примере 1 показано добавление треугольника к блоку через псевдоэлемент', messageFriends: 'Да я не знаю, как там это всё делать' },
